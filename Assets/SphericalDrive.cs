...
// Adapted by Oisin Murphy to allow Spherical Motion - based on Circular drive
//
// Purpose: Interactable that can be used to move in a spherical motion
//
//=============================================================================
...
namespace Valve.VR.InteractionSystem {
    ...
    public class SphericalDrive : MonoBehaviour {
        ...
        public Axis_t axisOfRotation_1 = Axis_t.XAxis;
        public Axis_t axisOfRotation_2 = Axis_t.ZAxis;
        ...
        [HeaderAttribute("Limited Rotation Min 1")]
        ...
        [HeaderAttribute("Limited Rotation Max 1")]
        ...
        [HeaderAttribute("Limited Rotation Min 2")]
        [Tooltip("If limited is true, the specifies the lower limit, otherwise value is unused")]
        public float minAngle_2 = -45.0f;
        [Tooltip("If limited, set whether drive will freeze its angle when the min angle is reached")]
        public bool freezeOnMin_2 = false;
        [Tooltip("If limited, event invoked when minAngle is reached")]
        public UnityEvent onMinAngle_2;

        [HeaderAttribute("Limited Rotation Max 2")]
        [Tooltip("If limited is true, the specifies the upper limit, otherwise value is unused")]
        public float maxAngle_2 = 45.0f;
        [Tooltip("If limited, set whether drive will freeze its angle when the max angle is reached")]
        public bool freezeOnMax_2 = false;
        [Tooltip("If limited, event invoked when maxAngle is reached")]
        public UnityEvent onMaxAngle_2;
        ...
        private void Start() {
            ...
            worldPlaneNormal[(int)axisOfRotation_1] = 1.0f;
            ...
            if (limited) {
                ...
                outAngle = transform.localEulerAngles[(int)axisOfRotation_1];
                ...
                start = Quaternion.AngleAxis(transform.localEulerAngles[(int)axisOfRotation_1], localPlaneNormal);
                outAngle = 0.0f;
            }
