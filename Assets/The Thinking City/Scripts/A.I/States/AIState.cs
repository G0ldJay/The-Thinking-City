...
public abstract class AIState : MonoBehaviour 
{
	...
	public virtual void SetStateMachine( AIStateMachine stateMachine ) { _stateMachine = stateMachine; } //Sets state machine 

	// Default Handlers
	public virtual void			OnEnterState()			{} //Default on enter state function 
	public virtual void 		OnExitState()			{} //Default on exit state function 
	public virtual void 		OnAnimatorIKUpdated()	{} //Animation Kinematics 
	public virtual void 		OnTriggerEvent( AITriggerEventType eventType, Collider other ){} //Trigger event
	public virtual void 		OnDestinationReached ( bool isReached ) {} //Destination reached function taking in if we've reached the destination or not 

	// Abtract Methods
	public abstract AIStateType GetStateType(); //Returns state type 
	public abstract AIStateType OnUpdate(); //Update for state type

	// Protected Fields
	protected AIStateMachine	_stateMachine; //Holds State machine
	...
	public virtual void 		OnAnimatorUpdated() 	
	{
		...
		// divide by deltaTime to get meters per second. Then assign this to
