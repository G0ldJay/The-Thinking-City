...
// DESC		:	State Machine used by Robot characters
// --------------------------------------------------------------------------
public class AIRobotStateMachine : AIStateMachine
{
    ...
    private int _lowerBodyDamageHash        = Animator.StringToHash("LowerBodyDamage");
    private int _upperBodyDamageHash        = Animator.StringToHash("UpperBodyDamage");
    private int _reanimateFromBackHash      = Animator.StringToHash("ReanimateFromBack");
    ...
    // -------------------------------------------------------------------
    // Name	:	TakeDamage
    // Desc	:	Processes the Robot reaction to being dealt damage
    // --------------------------------------------------------------------
    ...
    protected IEnumerator Reanimate()
    {
        ...
        //NOTE : Needs to be changed due to our character no longer being a Humanoid
