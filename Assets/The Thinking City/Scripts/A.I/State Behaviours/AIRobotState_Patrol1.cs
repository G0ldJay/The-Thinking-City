...
public class AIRobotState_Patrol1 : AIRobotState
{
    ...
    public override AIStateType OnUpdate()
    {
        ...
        if (_robotStateMachine.VisualThreat.type == AITargetType.Visual_Player)
        {
            ...
            int aiVoiceLine = Random.Range(0, 3);
            GameManager.instance.PlayAISound(aiVoiceLine);
        ...
        // If root rotation is not being used then we are responsible for keeping Robot rotated
